...
//
///**
// * @description： 执行自动创建代码
// * @author     ：lwl
// * @date       ：2020/12/30 13:45
// * @version:     1.0.0
// */
//public class MpGeneratorExecute {
//
//
//    public static void execute(MpGeneratorParam param) throws GeneratorException {
//        checkParam(param);
//        doExecute(param);
//    }
//
...
//     */
//    public static void executeLocal() throws GeneratorException {
//        MpGeneratorParam param = getParam(null);
//        execute(param);
//    }
//
//    private static void doExecute(MpGeneratorParam param) {
...
//    }
//
//    private static void setConfig(MpGeneratorParam param, AutoGenerator mpg) {
...
//
//
//    private static void addMysql(AutoGenerator mpg,MpGeneratorParam param){
...
//    }
//
//    public static Properties initProperties(String propertiesPath) throws GeneratorException {
//        Properties properties = new Properties();
//        try{
//            propertiesPath = StringUtils.isBlank(propertiesPath)?"generator//templates//generator.properties":propertiesPath;
...
//    }
//
//    private static MpGeneratorParam getParam(String propertiesPath) throws GeneratorException {
