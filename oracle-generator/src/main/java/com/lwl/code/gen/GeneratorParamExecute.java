...
public class GeneratorParamExecute extends GeneratorParamTemplate {

    @Override
    public Properties initProperties(String propertiesPath) throws GeneratorException {
        Properties properties = new Properties();
        try{
            propertiesPath = StringUtils.isBlank(propertiesPath)?"templates1//generator.properties":propertiesPath;
